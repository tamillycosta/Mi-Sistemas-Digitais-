...
module soc_system_mm_interconnect_0 (
	...
	wire  [128:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_011:sink_data
	...
	wire          pio_3_s1_agent_rp_valid;                                                            // pio_3_s1_agent:rp_valid -> router_012:sink_valid
	wire  [128:0] pio_3_s1_agent_rp_data;                                                             // pio_3_s1_agent:rp_data -> router_012:sink_data
	wire          pio_3_s1_agent_rp_ready;                                                            // router_012:sink_ready -> pio_3_s1_agent:rp_ready
	wire          pio_3_s1_agent_rp_startofpacket;                                                    // pio_3_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          pio_3_s1_agent_rp_endofpacket;                                                      // pio_3_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_1_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_1_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_1_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_1_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_1_s1_burst_adapter:sink0_endofpacket
	...
	wire    [7:0] pio_1_s1_burst_adapter_source0_channel;                                             // pio_1_s1_burst_adapter:source0_channel -> pio_1_s1_agent:cp_channel
	...
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_0_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> pio_2_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_2_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // pio_2_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_2_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> pio_2_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> pio_2_s1_burst_adapter:sink0_endofpacket
	...
	wire    [7:0] pio_2_s1_burst_adapter_source0_channel;                                             // pio_2_s1_burst_adapter:source0_channel -> pio_2_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> pio_3_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_3_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // pio_3_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_3_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> pio_3_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> pio_3_s1_burst_adapter:sink0_endofpacket
	...
	wire    [7:0] pio_3_s1_burst_adapter_source0_channel;                                             // pio_3_s1_burst_adapter:source0_channel -> pio_3_s1_agent:cp_channel
	...
	wire          pio_1_s1_agent_rdata_fifo_out_valid;                                                // pio_1_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] pio_1_s1_agent_rdata_fifo_out_data;                                                 // pio_1_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          pio_1_s1_agent_rdata_fifo_out_ready;                                                // avalon_st_adapter_004:in_0_ready -> pio_1_s1_agent_rdata_fifo:out_ready
	...
	wire          pio_2_s1_agent_rdata_fifo_out_valid;                                                // pio_2_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_2_s1_agent_rdata_fifo_out_data;                                                 // pio_2_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          pio_2_s1_agent_rdata_fifo_out_ready;                                                // avalon_st_adapter_006:in_0_ready -> pio_2_s1_agent_rdata_fifo:out_ready
	...
	wire          pio_3_s1_agent_rdata_fifo_out_valid;                                                // pio_3_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] pio_3_s1_agent_rdata_fifo_out_data;                                                 // pio_3_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          pio_3_s1_agent_rdata_fifo_out_ready;                                                // avalon_st_adapter_007:in_0_ready -> pio_3_s1_agent_rdata_fifo:out_ready
