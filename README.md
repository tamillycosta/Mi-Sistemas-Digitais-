...
<table align="center">
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matrizSomaTest.png" alt="Resultado da adição" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matrizSubTest.png" alt="Resultado da subtração" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matrizMultTest.png" alt="Resultado da multiplicação" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matriz2x2Test.png" alt="Resultado do determinante 2x2" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matriz3x3Test.png" alt="Resultado do determinante 3x3" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matriz4x4Test.png" alt="Resultado do determinante 4x4" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/matriz5x5Test.png" alt="Resultado do determinante 5x5" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">
      <img src="testesImagens/marizTransTest.png" alt="Resultado da transposição" width="200px" style="border: 1px solid #ccc; border-radius: 8px;">
      <p><em>Resultado obtido por calculadora de matrizes</em></p>
    </td>
  </tr>
...
- **GATE.IO**. Uma breve introdução aos coprocessadores. Disponível em: [https://www.gate.io/pt-br/learn/articles/a-brief-intro-to-coprocessors/1066](https://www.gate.io/pt-br/learn/articles/a-brief-intro-to-coprocessors/1066). Acesso em: 6 abr. 2025.

- **INTEL CORPORATION**. *Intel® Quartus® Prime Pro Edition User Guide*. [S.l.], 12 dez. 2022. Disponível em: [https://cdrdv2-public.intel.com/749871/ug-683819-749871.pdf](https://cdrdv2-public.intel.com/749871/ug-683819-749871.pdf). Acesso em: 6 abr. 2025.

- **LIRTE – Laboratório de Iniciação Científica em Tecnologias e Educação**. *Operações com matrizes – Álgebra Linear*. Disponível em: [https://lirte.pesquisa.ufabc.edu.br/matreematica/a-matematica-do-cotidiano/ramos/algebra/algebra-linear/operacoes-com-matrizes/](https://lirte.pesquisa.ufabc.edu.br/matreematica/a-matematica-do-cotidiano/ramos/algebra/algebra-linear/operacoes-com-matrizes/). Acesso em: 6 abr. 2025.

- **MUSEU CAPIXABA**. Coprocessador matemático. Disponível em: [https://museucapixaba.com.br/glossary/coprocessador-matematico/](https://museucapixaba.com.br/glossary/coprocessador-matematico/). Acesso em: 6 abr. 2025.

- **PATTERSON, David; HENNESSY, John L.** *Organização e projeto de computadores*. 5. ed. Rio de Janeiro: Elsevier, 2017.
